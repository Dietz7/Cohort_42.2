// Okruglenije chisla vverch
let roundUp = Math.ceil(4.2)
console.log(roundUp);// 5
// Okruglenije chisla vniz
...
console.log(power); // 8
// generation of the random number from 0 to 1
...
const years = prompt("Сколько вам лет?"); // it will work in browser
alert("Вам"+ " " + years + " " + "лет")// in browser
